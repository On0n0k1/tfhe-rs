...
struct GpuUncheckedFnExecutor<F> {
...
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_mul);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_add);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_add_assign);
...
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_scalar_add);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_small_scalar_mul);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_sub);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_scalar_sub);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_neg);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::mul);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::add);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::scalar_add);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::small_scalar_mul);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::sub);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::scalar_sub);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::neg);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::bitnot);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::bitand);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::bitor);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::bitxor);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::scalar_bitand);
...
where
    P: Into<PBSParameters>,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::scalar_bitor);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::scalar_bitxor);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_scalar_left_shift);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_scalar_right_shift);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::scalar_right_shift);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::scalar_left_shift);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_scalar_left_rotate);
...
where
    P: Into<PBSParameters> + Copy,
{
    let executor = GpuUncheckedFnExecutor::new(&CudaServerKey::unchecked_scalar_right_rotate);
