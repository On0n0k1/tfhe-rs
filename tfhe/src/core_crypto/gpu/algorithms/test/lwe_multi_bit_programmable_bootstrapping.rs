...
>(
    ...
    while msg != Scalar::ZERO {
        ...
        for _ in 0..NB_TESTS {
            ...
            unsafe { d_test_vector_indexes.copy_to_gpu_async(&test_vector_indexes, &stream) };
            ...
            unsafe {
                d_input_indexes.copy_to_gpu_async(&lwe_indexes, &stream);
                d_output_indexes.copy_to_gpu_async(&lwe_indexes, &stream);
            }
